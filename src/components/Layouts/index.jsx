...
export default function Layout(props) {
    ...
    return (
        <>
                        ...
                        {expand ?
                            <React.Fragment>
                                ...
                                <div className='px-[18px] overflow-hidden w-full whitespace-nowrap'>
                                    <Button type='danger' className='w-full' onClick={logoutConfirm}>Logout</Button>
                                </div>
                            </React.Fragment>
                            :
            ...
            {loggedOut && <PopUp status="danger" body_message="Apakah Anda yakin ingin logout?" action_message="Logout" />}
        </>
    );
};
