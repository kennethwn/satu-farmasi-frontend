...
export default function Layout(props) {
    const { user, active = "dashboard" } = props;
    ...
    const renderIcon = (icon, isActive) => {
        ...
        let firstIconName =
            typeof icon === "string" ? icon.split("-")[0] : null;
                        ...
                        <Nav defaultActiveKey="dashboard">
                            ...
                            {userRole === "doctor" && (
                                <Nav.Item
                                    ...
                                    icon={<GroupIcon />}
                                    onClick={() => {
                                        router.push("/diagnose", undefined, {
                                            shallow: true,
                                        });
                                        ...
                                        {userRole === "pharmacist" && (
                                            <>
                                                ...
                                                <Nav.Item
                                                    ...
                                                    eventKey="master-classification"
                                                >
                                                    {renderTitle(
                                                        "Klasifikasi Obat",
                                                        "child",
